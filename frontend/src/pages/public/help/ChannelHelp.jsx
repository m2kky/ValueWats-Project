...
export default function ChannelHelp() {
    ...
    const data = isConnect ? activeChannel.connect : activeChannel.overview;

    return (
        <HelpCenterLayout title={data.title} lastUpdated="March 2026">
            <div className="flex items-center gap-2 mb-8">
                <Link to="/help" className="text-zinc-500 hover:text-zinc-300 text-sm">Help Center</Link>
                <span className="text-zinc-700">/</span>
                <span className="text-zinc-300 text-sm font-bold">{activeChannel.name}</span>
            </div>
