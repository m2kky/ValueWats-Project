...
const channelCollections = [
    {
        id: 'whatsapp',
        name: 'WhatsApp',
        description: 'Connect WhatsApp accounts via QR code or Cloud API.',
        icon: (
    ...
    },
    {
        id: 'tiktok',
        name: 'TikTok',
        description: 'Connect TikTok Business Messaging to engage with TikTok audience.',
        icon: (
        ...
        articleCount: 2,
        link: '/help/channels/tiktok'
    },
    {
        id: 'telegram',
        name: 'Telegram',
        description: 'Connect Telegram Bot for lightning-fast customer support.',
        icon: (
