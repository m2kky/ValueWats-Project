                    ...
                    <div className="grid md:grid-cols-2 gap-12 items-center mb-24">
                        <div>
                            ...
                            <p className="text-lg text-zinc-400 mb-6">
                                Stop juggling between a CRM, a shared inbox, an automation builder, and a separate AI platform. ValueWats brings all these capabilities into a single, cohesive interface.
                            </p>
                        ...
                        <div className="bg-zinc-900 rounded-2xl p-8 border border-zinc-800 shadow-2xl">
                            <div className="flex justify-between items-center mb-6 pb-6 border-b border-zinc-800">
                                ...
                                <span className="text-white font-semibold flex items-center"><svg className="w-5 h-5 mr-1" fill="currentColor" viewBox="0 0 20 20"><path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm1-11a1 1 0 10-2 0v2H7a1 1 0 100 2h2v2a1 1 0 102 0v-2h2a1 1 0 100-2h-2V7z" clipRule="evenodd"></path></svg> ValueWats</span>
