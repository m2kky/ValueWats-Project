                ...
                >
                  ...
                  <div className="flex flex-col h-full mt-6">
                    ...
                    <button 
                      ...
                      className="mt-auto flex items-center justify-center gap-2 w-full py-2.5 rounded-xl text-sm font-bold bg-[#1c1f26] text-white border border-white/10 hover:bg-white/10 hover:border-white/20 transition-all uppercase tracking-wider italic"
                    >
                      Connect
                    </button>
                  </div>
