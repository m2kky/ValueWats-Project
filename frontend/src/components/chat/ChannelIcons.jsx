...
// Facebook Messenger official logo
export const MessengerIcon = ({ className = "w-4 h-4" }) => (
  <svg className={className} viewBox="0 0 24 24" fill="currentColor">
...
export const channelColors = {
  whatsapp: { text: 'text-[#25D366]', bg: 'bg-[#25D366]/10', border: 'border-[#25D366]/20' },
  messenger: { text: 'text-[#0084FF]', bg: 'bg-[#0084FF]/10', border: 'border-[#0084FF]/20' },
  instagram: { text: 'text-[#E4405F]', bg: 'bg-[#E4405F]/10', border: 'border-[#E4405F]/20' },
};

// Get the right icon component for a channel
export const getChannelIcon = (channelType) => {
  switch (channelType) {
