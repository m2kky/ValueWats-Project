            ...
            <tr>
              <td align="center">
                <div style="width: 72px; height: 72px; margin-bottom: 24px;">
                  <img src="data:image/svg+xml;base64,${loaderBase64}" width="72" height="72" style="display: block;" alt="ValueWats" />
                </div>
            ...
            <tr>
              <td align="center">
                ...
                <div style="background-color: #18181b; border: 1px solid rgba(255,255,255,0.05); border-radius: 12px; padding: 24px; text-align: center; margin-bottom: 32px;">
                  ...
                  <a href="https://app.muhammedmekky.com/login" style="display: inline-block; background-color: #818cf8; color: #0f0f12; font-weight: 600; text-decoration: none; padding: 12px 24px; border-radius: 8px; font-size: 15px;">Accept Invitation</a>
                </div>
